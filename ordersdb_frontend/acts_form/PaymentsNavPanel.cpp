...
void CPaymentsNavPanel::Create(XWindow *parent, const int flags, \
	...
	main_sizer.pushNestedSizer(sizer);
		...
		sizer.addWidget(new XLabel(), _T("Апл м"), label_flags, XSize(45, LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Сл м"), label_flags, XSize(40, LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Відм ап"), label_flags, XSize(70, LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Зм квал кр"), label_flags, XSize(90, LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Зменш еп"), label_flags, XSize(75, LABELS_HEIGHT));
	...
	main_sizer.pushNestedSizer(sizer);
		...
		sizer.addWidget(new XLabel(), _T("Зм мед"), label_flags, XSize(50, LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Скас мед"), label_flags, XSize(60, LABELS_HEIGHT));
