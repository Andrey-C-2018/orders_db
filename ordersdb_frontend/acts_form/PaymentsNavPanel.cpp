...
void CPaymentsNavPanel::Create(XWindow *parent, const int flags, \
	...
	main_sizer.pushNestedSizer(sizer);
		...
		sizer.addWidget(new XLabel(), _T("Â³ê"), label_flags, XSize(25, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Âàäè"), label_flags, XSize(35, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Ìîâà"), label_flags, XSize(35, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Õâîðîáà"), label_flags, XSize(58, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("ÇÅÊ"), label_flags, XSize(30, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Âèïð."), label_flags, XSize(40, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Çìåíø"), label_flags, XSize(47, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Çì³íà"), label_flags, XSize(40, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Çàêð."), label_flags, XSize(40, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Çâ³ëüí"), label_flags, XSize(55, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Ì³í."), label_flags, XSize(35, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Íàéì. ñóâ."), label_flags, XSize(70, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Çâ³ëüí. êð"), label_flags, XSize(70, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Áåç çì 1 ³íñò"), label_flags, XSize(90, QA_LABELS_HEIGHT));
		sizer.addWidget(new XLabel(), _T("Êçâ³ò"), label_flags, XSize(40, QA_LABELS_HEIGHT));
