...
struct IDbResultSet {
	...
	virtual int getInt(const size_t field, const size_t record) const = 0;
	virtual const char *getString(const size_t field, \
									const size_t record) const = 0;
	virtual const wchar_t *getWString(const size_t field, \
									const size_t record) const = 0;
	virtual ImmutableString<char> getImmutableString(const size_t field, \
									const size_t record) const = 0;
