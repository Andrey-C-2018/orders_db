...
constexpr char getDotChar(const char) { return '.'; }
constexpr wchar_t getDotChar(const wchar_t) { return L'.'; }

constexpr char getZeroChar(const char) { return '0'; }
constexpr wchar_t getZeroChar(const wchar_t) { return L'0'; }

constexpr char getOneChar(const char) { return '1'; }
constexpr wchar_t getOneChar(const wchar_t) { return L'1'; }
